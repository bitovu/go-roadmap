...
| -------------------- | ------------------- | ------------------------------- | ----------------------- |
| Чтение (<-ch)        | БЛОК до писателя❌ | Zero value, НЕ блокируется ✅| БЛОК навсегда ❌          |
| Запись (ch <- v)     | БЛОК до читателя❌ | PANIC❌                      | БЛОК навсегда ❌          |
| close(ch)            | Закрывает канал✅  | PANIC ❌                     | PANIC❌                   |
```
...
| -------------------- | ------------------- | -----------------------  | --------------------------| -------------------------------- |
| Чтение (<-ch)        | БЛОК до писателя ❌   | Читает значение        | Читает значение✅        | Читает остатки, затем zero value |
| Запись (ch <- v)     | Записывает значение✅ | Записывает значение✅      | БЛОК до читател❌я  | PANIC  ❌                      |
```
